...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<LocalLeader>t', '<cmd>lua vim.lsp.buf.hover()<CR>', opts)
  ...
  buf_set_keymap('n', '<LocalLeader>K', '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts)
...
local servers = { 'pyright', 'ocamllsp' }
